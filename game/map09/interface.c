...
void init() {
	// Enemy tiles:
	host->LoadTexture(0, "textures/fgtile130.png");
	host->LoadTexture(1, "textures/fgtile131.png");
	host->LoadTexture(2, "textures/fgtile132.png");
	host->LoadTexture(3, "textures/fgtile133.png");
	...
	// Boss texture:
	host->LoadTexture(8, "textures/boss093.png");
