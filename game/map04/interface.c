...
void init() {
	...
	host->LoadTexture(0, "textures/fgtile020.png");
	host->LoadTexture(1, "textures/fgtile021.png");
	host->LoadTexture(2, "textures/fgtile022.png");
	host->LoadTexture(3, "textures/fgtile023.png");
...
///---Do not change this line!! It is used by scripts to add new entities!!---
	DEFINE_CLASS(CLASS_PTERODACTYL, ClassProperties_Pterodactyl, SPAWNFLAG_MAPSPAWNABLE)
	DEFINE_CLASS(CLASS_HERMIT, ClassProperties_Hermit, SPAWNFLAG_MAPSPAWNABLE)
	DEFINE_CLASS(CLASS_SWIMMER, ClassProperties_Swimmer, SPAWNFLAG_MAPSPAWNABLE)
