...
void init() {
	// Enemy tiles:
	host->LoadTexture(0, "textures/fgtile120.png");
	host->LoadTexture(1, "textures/fgtile121.png");
	host->LoadTexture(2, "textures/fgtile122.png");
	host->LoadTexture(3, "textures/fgtile123.png");
	...
	// Boss texture:
	host->LoadTexture(8, "textures/boss0C3.png");
