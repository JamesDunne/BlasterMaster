...
void init() {
	...
	host->LoadTexture(0, "textures/fgtile030.png");
	host->LoadTexture(1, "textures/fgtile031.png");
	host->LoadTexture(2, "textures/fgtile032.png");
	host->LoadTexture(3, "textures/fgtile033.png");
