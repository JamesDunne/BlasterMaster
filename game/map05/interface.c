...
void init() {
	...
	host->LoadTexture(0, "textures/fgtile010.png");
	host->LoadTexture(1, "textures/fgtile011.png");
	host->LoadTexture(2, "textures/fgtile012.png");
	host->LoadTexture(3, "textures/fgtile013.png");
...
///---Do not change this line!! It is used by scripts to add new entities!!---
	DEFINE_CLASS(CLASS_HAND, ClassProperties_Hand, SPAWNFLAG_MAPSPAWNABLE)
