...
void init() {
	// Enemy tiles:
	host->LoadTexture(0, "textures/fgtile110.png");
	host->LoadTexture(1, "textures/fgtile111.png");
	host->LoadTexture(2, "textures/fgtile112.png");
	host->LoadTexture(3, "textures/fgtile113.png");
	// Jason's + powerups + HUD tiles:
	host->LoadTexture(4, "textures/fgtile100.png");
	host->LoadTexture(5, "textures/fgtile101.png");
	host->LoadTexture(6, "textures/fgtile102.png");
	host->LoadTexture(7, "textures/fgtile103.png");
	// Boss texture:
	host->LoadTexture(8, "textures/boss083.png");
...
dllfunctions *DLLInitialize(hostfunctions *thost) {
	...
	common = GetGameAPI ("game/common_dungeon", host, &common_library);
	if (common == NULL) {
		fprintf(stderr, "Error loading common dungeon dll!\n");
		return NULL;
	}
...
///---Do not change this line!! It is used by scripts to add new entities!!---
	DEFINE_CLASS(CLASS_BOSS, ClassProperties_Boss, SPAWNFLAG_MAPSPAWNABLE)	
